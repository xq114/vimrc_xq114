...
" Generated by http://bytefluent.com/vivify 2019-02-25
...
hi SpecialComment guifg=#907000 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=94 ctermbg=254 cterm=NONE
hi Typedef guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi Title guifg=#a030a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=133 ctermbg=254 cterm=NONE
hi Folded guifg=#000000 guibg=#b0e0b0 guisp=#b0e0b0 gui=NONE ctermfg=NONE ctermbg=151 cterm=NONE
hi PreCondit guifg=#009030 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=28 ctermbg=254 cterm=NONE
hi Include guifg=#009030 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=28 ctermbg=254 cterm=NONE
...
hi Debug guifg=#907000 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=94 ctermbg=254 cterm=NONE
hi PMenuSbar guifg=NONE guibg=#000000 guisp=#000000 gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi Identifier guifg=#a030a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=133 ctermbg=254 cterm=NONE
hi SpecialChar guifg=#686868 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=242 ctermbg=254 cterm=NONE
hi Conditional guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi StorageClass guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi Todo guifg=#e0e090 guibg=#000080 guisp=#000080 gui=NONE ctermfg=186 ctermbg=18 cterm=NONE
hi Special guifg=#907000 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=94 ctermbg=254 cterm=NONE
hi LineNr guifg=#686868 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=242 ctermbg=254 cterm=NONE
hi StatusLine guifg=#000000 guibg=#a6caf0 guisp=#a6caf0 gui=NONE ctermfg=NONE ctermbg=153 cterm=NONE
hi Label guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi PMenuSel guifg=#000000 guibg=#008b8b guisp=#008b8b gui=NONE ctermfg=NONE ctermbg=30 cterm=NONE
hi Search guifg=#902000 guibg=#f8f8f8 guisp=#f8f8f8 gui=NONE ctermfg=88 ctermbg=15 cterm=NONE
hi Delimiter guifg=#907000 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=94 ctermbg=254 cterm=NONE
hi Statement guifg=#4020a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=19 ctermbg=254 cterm=NONE
hi Comment guifg=#505800 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=58 ctermbg=254 cterm=NONE
hi Character guifg=#907000 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=94 ctermbg=254 cterm=NONE
hi Float guifg=#907000 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=94 ctermbg=254 cterm=NONE
hi Number guifg=#907000 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=94 ctermbg=254 cterm=NONE
hi Boolean guifg=#4020a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=19 ctermbg=254 cterm=NONE
hi Operator guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi Question guifg=#000000 guibg=#d0d090 guisp=#d0d090 gui=NONE ctermfg=NONE ctermbg=186 cterm=NONE
hi WarningMsg guifg=#b02000 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=124 ctermbg=254 cterm=NONE
...
hi Define guifg=#009030 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=28 ctermbg=254 cterm=NONE
hi Function guifg=#a030a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=133 ctermbg=254 cterm=NONE
...
hi Visual guifg=#000000 guibg=#a6caf0 guisp=#a6caf0 gui=NONE ctermfg=NONE ctermbg=153 cterm=NONE
...
hi Exception guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi Keyword guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi Type guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi DiffChange guifg=#000000 guibg=#e0b0e0 guisp=#e0b0e0 gui=NONE ctermfg=NONE ctermbg=182 cterm=NONE
hi Cursor guifg=#f0f0f0 guibg=#008000 guisp=#008000 gui=NONE ctermfg=255 ctermbg=2 cterm=NONE
hi Error guifg=#c03000 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=1 ctermbg=254 cterm=NONE
hi PMenu guifg=#e0e0e0 guibg=#c0c0c0 guisp=#c0c0c0 gui=NONE ctermfg=254 ctermbg=7 cterm=NONE
hi SpecialKey guifg=#1050a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi Constant guifg=#007068 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=6 ctermbg=254 cterm=NONE
hi Tag guifg=#a030a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=133 ctermbg=254 cterm=NONE
hi String guifg=#007068 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=6 ctermbg=254 cterm=NONE
hi PMenuThumb guifg=NONE guibg=#a9a9a9 guisp=#a9a9a9 gui=NONE ctermfg=NONE ctermbg=248 cterm=NONE
hi Repeat guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi Directory guifg=#a030a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=133 ctermbg=254 cterm=NONE
hi Structure guifg=#0850a0 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=25 ctermbg=254 cterm=NONE
hi Macro guifg=#009030 guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=28 ctermbg=254 cterm=NONE
hi Underlined guifg=#6a5acd guibg=#e0e0e0 guisp=#e0e0e0 gui=NONE ctermfg=62 ctermbg=254 cterm=NONE
hi DiffAdd guifg=#000000 guibg=#b0b0e0 guisp=#b0b0e0 gui=NONE ctermfg=NONE ctermbg=146 cterm=NONE
